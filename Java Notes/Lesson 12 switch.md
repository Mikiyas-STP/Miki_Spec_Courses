Perfect. This is one of the most important topics in programming. A huge percentage of algorithms use loops, so it's worth understanding them deeply rather than memorising the syntax.
